...
import { TbBackground, TbBrandGithub } from "react-icons/tb";
  ...
  return (
    <>
      ...
      <main className="hero">
        ...
        <div className="github_conteiner">
          <button className="github">
            get started <FaArrowRightLong />
          </button>
          <button className="respository">github respository</button>
        </div>
      </main>
    </>
  );
